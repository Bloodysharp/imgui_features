...
//#endif
    ...
    IMGUI_API bool          Tabs(bool selected, const char* icon, const char* label, const char* hint, const ImVec2& size_arg);
    IMGUI_API bool          TabsHor(bool selected, const char* icon, const char* label, const char* hint, const ImVec2& size_arg);
