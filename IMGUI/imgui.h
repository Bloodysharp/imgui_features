...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* preview_value, int val, bool multi = false, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API bool          SliderScalarF(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
    ...
    bool CustomBeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border = false, ImGuiWindowFlags flags = 0);

    bool CustomBeginChild(const char* str_id, const ImVec2& size_arg, bool border = false, ImGuiWindowFlags extra_flags = 0);

    bool CustomBeginChild(ImGuiID id, const ImVec2& size_arg, bool border = false, ImGuiWindowFlags extra_flags = 0);

    void CustomEndChild();

    IMGUI_API bool          CustomBeginChildFrame(ImGuiID id, const ImVec2& size, ImGuiWindowFlags extra_flags = 0);

    void CustomEndChildFrame();
